...
const cucumberJsonDir = 'reports/cucumber-json-reports/'
const cucumberReportFileMap = {}
const cucumberReportMap = {}
const jsonIndentLevel = 2
const htmlReportDir = 'reports/cucumber-html-report/'
...
function generateReport() {
  if (!fs.existsSync(cucumberJsonDir)) {
    ...
    report.generate({
      ...
      pageTitle: 'Todos-Test Report',
      reportName: `Todos Test Report - ${new Date().toLocaleString()}`,
      hideMetadata: true,
    })
  }
}
